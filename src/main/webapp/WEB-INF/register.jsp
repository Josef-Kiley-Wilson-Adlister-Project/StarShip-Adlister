    ...
    <div class="container">
        ...
        <form action="/register" method="post">
            ...
            <div class="form-group">
                ...
                <input id="email" name="email" class="form-control bg-transparent text-white" type="text">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input id="confirm_password" name="confirm_password" class="form-control bg-transparent text-white" type="password">
            </div>
